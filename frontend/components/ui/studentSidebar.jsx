    ...
    >
      ...
      <nav className="flex-1 overflow-y-auto space-y-1">
        ...
        >
          ...
          {!collapsed && (
            <span className="flex-1 text-left">My Attendance</span>
          )}
        </button>
        ...
        <button
          type="button"
          onClick={() => onViewChange && onViewChange("support")}
          className={navItemClass(currentView === "support")}
        >
